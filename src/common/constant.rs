...
pub const PLAYER_URL: &str = "https://raw.githubusercontent.com/Baabacar/player_model/main/player.glb";
pub const ENEMY_URL: &str = "https://raw.githubusercontent.com/Baabacar/player_model/main/enemy.glb";
